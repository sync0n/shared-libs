    ...
    pipeline {
        ...
        stages {
            ...
            stage ('Unit Test') {
                steps {
                    dir (props.projectPath) {
                        dotnetTests(props.projectTestDir, props.projTestFile)
                    }
                }
            }
            ...
            stage('SonarQube Analysis') {
				steps {
                    dir (props.projectPath) {
                        dotnetSonarQube(props.appName, props.projectDir, props.projectTestDir, props.projFile, fromMaster)
					}
				}
			}
            ...
            stage('Compile & Build Package') {
				steps {
                    dir (props.projectPath) {
                        dotnetBuild(props.projFile, fromMaster)
					}
				}
			}
